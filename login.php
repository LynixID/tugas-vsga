                ...
                <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                    ...
                    <form action="#" method="POST" class="mt-8">
                        <div class="space-y-5">
                            ...
                            <div>
                                <button type="submit" class="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-md focus:outline-none hover:bg-blue-700 focus:bg-blue-700"><a href="index_admin.php">Log
                                        in</a></button>
                            </div>
                        </div>
                    </form>
